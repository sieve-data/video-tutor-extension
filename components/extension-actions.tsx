        ...
        <div className="flex items-center justify-between">
          <div className="flex justify-center items-center space-x-2">
            ...
            <Button
              ...
              <Pencil2Icon className={`h-4 w-4 ${extensionPanel === "Learn" ? "opacity-90" : "opacity-60"}`} />
              <span className={extensionPanel === "Learn" ? "opacity-100 font-medium" : "opacity-90"}>Learn</span>
            </Button>
            <Button
              variant="outline"
              onClick={() => {
              ...
              <ActivityLogIcon className={`h-4 w-4 ${extensionPanel === "Transcript" ? "opacity-90" : "opacity-60"}`} />
              <span className={extensionPanel === "Transcript" ? "opacity-100 font-medium" : "opacity-90"}>Transcript</span>
            </Button>
            <Button
              variant="outline"
              onClick={() => {
              ...
              <ChatBubbleIcon className={`h-4 w-4 ${extensionPanel === "Chat" ? "opacity-90" : "opacity-60"}`} />
              <span className={extensionPanel === "Chat" ? "opacity-100 font-medium" : "opacity-90"}>Chat</span>
            </Button>
            </div>
          </div>
